...
class App extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <Slider title={"Height"} min={90} max={245} value={height} onChange={this.handleHeightChange} units="cm"/>
                <Slider title={"Weight"} min={35} max={200} value={weight} onChange={this.handleWeightChange} units="kg"/>
                <div>BMI: <b>{bmi} {bmiResult}</b> </div>
            </div>
        );
    }
